...
class RedirectiondVideoCard extends StatelessWidget {
  const RedirectiondVideoCard({
    required this.user,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Icon(Icons.video_camera_back_rounded,color: AppColor.text_quarterary,),
                        ),
                      ],
                    ),
                  ),
